...
<p align="center">
    ...
    <br>
    <em>Crack segmentation challenges for synthetically-degraded images given by low resolution and anisotropic Gaussian blur. Our method (f) CSBSR succeeds in detecting cracks in the most detail compared to previous studies (d), (e). Moreover, in several cases, despite inference from degraded images, it successfully detected cracks when using true high-resolution images.</em>
</p>
