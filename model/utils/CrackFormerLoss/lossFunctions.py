...
## Huajun Liu et al.
## This code is based on https://github.com/LouisNUST/CrackFormer-II, not licensed as of April 27, 2024.
##+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
def cross_entropy_loss_RCF(prediction, label):
    label = label.long().expand(label.shape[0], prediction.shape[1], *label.shape[2:])
    # label2 = label.float()
    mask = label.float()
    ...
    mask[mask == 2] = 0
    # prediction = sigmoid(prediction) # usinc sigmoid in the network
