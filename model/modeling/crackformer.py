...
## Huajun Liu et al.
## This code is based on https://github.com/LouisNUST/CrackFormer-II, is not licensed as of April 27, 2024.
##+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
class CrackFormer(nn.Module):
    ...
    def forward(self, inputs):
        ...
        fuse = self.final(torch.cat([fuse5, fuse4, fuse3, fuse2, fuse1], 1))

        sides = torch.cat([self.sigmoid(i) for i in [fuse5, fuse4, fuse3, fuse2, fuse1]], 1)

        return self.sigmoid(fuse), sides
